   ...
   final void doCycleLoggedOut() {
      ...
      try {
         ...
         if (loginState == 5) {
            ...
            var33.packetBuffer.writeIntIME(class12.archive12.hash);//done
            var33.packetBuffer.writeIntIME(class372.archive2.hash);//done
            var33.packetBuffer.writeIntIME(ApproximateRouteStrategy.archive10.hash);//done
            var33.packetBuffer.writeIntLE(MusicPatchNode.field3448.hash);//done
            var33.packetBuffer.writeIntME(NetCache.archive9.hash);//done
            var33.packetBuffer.writeIntLE(0);//done
            var33.packetBuffer.writeIntLE(class174.archive14.hash);//done
            var33.packetBuffer.writeInt(GameEngine.archive19.hash);//done
            var33.packetBuffer.writeIntME(class419.archive18.hash);//done
            var33.packetBuffer.writeInt(class27.archive20.hash);//done
            var33.packetBuffer.writeIntIME(class13.field70.hash);//done
            var33.packetBuffer.writeIntLE(class144.archive4.hash);//done
            var33.packetBuffer.writeIntME(WorldMapEvent.archive8.hash);//done
            var33.packetBuffer.writeInt(PendingSpawn.archive13.hash);//done
            var33.packetBuffer.writeIntME(class153.archive6.hash);//done
            var33.packetBuffer.writeIntME(class286.archive15.hash);//done
            var33.packetBuffer.writeIntIME(class148.field1704.hash);//done
            var33.packetBuffer.writeIntIME(class151.archive11.hash);//done
            var33.packetBuffer.writeIntLE(CollisionMap.archive17.hash);//done
            var33.packetBuffer.writeInt(DynamicObject.field1001.hash);//done
                                                                  ...
                                                                  if (MouseHandler.MouseHandler_currentButton == 0) {
                                                                     if (field624) {
                                                                        if (WorldMapLabelSize.dragInventoryWidget == class157.hoveredItemContainer && dragItemSlotSource != dragItemSlotDestination) {
                                                                           ...
                                                                           var18.packetBuffer.writeIntIME(WorldMapLabelSize.dragInventoryWidget.id);
                                                                           packetWriter.addNode(var18);
                                                                        }
                                                         ...
                                                         case 1:
                                                            if (NewStuff.method3716(class173.getWidgetFlags(var45.field2324))) {
                                                               ...
                                                               if (var44 != null) {
                                                                  ...
                                                                  var18.packetBuffer.writeIntME(var44[1]);
                                                                  var18.packetBuffer.writeInt(var45.field2324.method6335());
                                                                  var18.packetBuffer.writeIntIME(var45.field2324.id);
                                                                  var18.packetBuffer.writeShortAddLE(var45.field2324.childIndex);
                                                                  var18.packetBuffer.writeIntME(var44[0]);
                                                                  packetWriter.addNode(var18);
                                                               }
                                                            }
                                                      }
      ...
      if (var2 == null) {
         ...
         try {
            ...
            if (ServerPacket.field3301 == var1.serverPacket) {
               Decimator.method1123(class280.LOC_ANIM);
               var1.serverPacket = null;
               return true;
            }
            ...
            if (ServerPacket.field3230 == var1.serverPacket) {
               Decimator.method1123(class280.OBJ_COUNT);
               var1.serverPacket = null;
               return true;
            }
            ...
            if (ServerPacket.field3247 == var1.serverPacket) {
               Decimator.method1123(class280.AREA_SOUND);
               var1.serverPacket = null;
               return true;
            }

            if (ServerPacket.field3228 == var1.serverPacket) {
               Decimator.method1123(class280.LOC_COMBINE);
               var1.serverPacket = null;
               return true;
            }
            ...
            if (ServerPacket.GRAPHICSOBJECT_SPAWN == var1.serverPacket) {
               int startDelay = var3.readUnsignedShort();
               int offsetHeight = var3.readUnsignedByteNeg();
               int id = var3.readUnsignedShortAdd();
               int localHash = var3.method8843();
               int chunkX = localHash >> 16;
               int chunkY = localHash >> 8 & 255;
               int localX = chunkX + (localHash >> 4 & 7);
               int localY = chunkY + (localHash & 7);
               if (localX >= 0 && localY >= 0 && localX < 104 && localY < 104) {
                  localX = localX * 128 + 64;
                  localY = localY * 128 + 64;
                  GraphicsObject var93 = new GraphicsObject(id, class103.Client_plane, localX, localY, GrandExchangeOfferNameComparator.getTileHeight(localX, localY, class103.Client_plane) - offsetHeight, startDelay, cycle);
            ...
            if (ServerPacket.field3198 == var1.serverPacket) {
               Decimator.method1123(class280.MAP_ANIM);
               var1.serverPacket = null;
               return true;
            }
            ...
            if (ServerPacket.field3193 == var1.serverPacket) {
               Decimator.method1123(class280.LOC_DEL);
               var1.serverPacket = null;
               return true;
            }
            ...
            if (ServerPacket.field3215 == var1.serverPacket) {
               Decimator.method1123(class280.LOC_ADD_CHANGE);
               var1.serverPacket = null;
               return true;
            }
            ...
            if (ServerPacket.field3233 == var1.serverPacket) {
               Decimator.method1123(class280.MAPPROJ_ANIM);
               var1.serverPacket = null;
               return true;
            }
            ...
            if (ServerPacket.field3202 == var1.serverPacket) {
               Decimator.method1123(class280.OBJ_FLAGS);
               var1.serverPacket = null;
               return true;
            }
            ...
            if (ServerPacket.field3223 == var1.serverPacket) {
               Decimator.method1123(class280.OBJ_ADD);
               var1.serverPacket = null;
               return true;
            }
            ...
            if (ServerPacket.field3206 == var1.serverPacket) {
               Decimator.method1123(class280.OBJ_DEL);
               var1.serverPacket = null;
               return true;
            }
            ...
            if (ServerPacket.PING_STATISTICS_REQUEST == var1.serverPacket) {
               ...
               var22.packetBuffer.writeIntME(var20);
            ...
            if (isMenuOpen) {
               ...
               if (var1 != 1 && (ClanMate.mouseCam || var1 != 4)) {
                  ...
                  if (var2 < class130.menuX - 10 || var2 > class130.menuX + class7.menuWidth + 10 || var3 < ModeWhere.menuY - 10 || var3 > PlayerType.menuHeight + ModeWhere.menuY + 10) {
                     isMenuOpen = false;
                     Language.invalidateMenu(class130.menuX, ModeWhere.menuY, class7.menuWidth, PlayerType.menuHeight);
                  }
               }
               ...
               if (var1 == 1 || !ClanMate.mouseCam && var1 == 4) {
                  ...
                  if (var10 != -1) {
                     FloorDecoration.createMenuAction(var10);
                  }
               ...
               if ((var1 == 1 || !ClanMate.mouseCam && var1 == 4) && menuOptionsCount > 0) {
                  FloorDecoration.createMenuAction(var2);
               }
